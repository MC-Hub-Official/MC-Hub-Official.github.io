...
class MCHubFooter extends HTMLElement {
  connectedCallback() {
    ...
    this.insertAdjacentHTML("beforeend", '<a class="fa fa-youtube" href="https://www.youtube.com/channel/UCP2347E62P5fcoC2eK8QiPg?sub_confirmation=1"></a><a href="/rss.xml" class="fa fa-rss" download></a>');

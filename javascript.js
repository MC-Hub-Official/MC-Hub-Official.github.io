...
class MCHubHeader extends HTMLElement {
  connectedCallback() {
    this.innerHTML = '<div class="logo"><img src="https://exf.mchub.ga/logos/logo.png" alt="MC Hub Logo" /><br></div><div class="navbar"><div class="dropdown"><button class="dropbtn">Menu</button><div class="dropdown-content"><a href="/">Hub</a><a href="/tips">Tips</a><a href="/facts">Facts</a><a href="/seeds">Seeds</a><a href="/commands">Commands</a><a href="/search"> Search </a></div></div></div><br><br><br>';
  }
}

...
var d = new Date();
var bgImages = ["url(https://exf.mchub.ga/backgrounds/0.png)", "url(https://exf.mchub.ga/backgrounds/1.png)", "url(https://exf.mchub.ga/backgrounds/2.png)", "url(https://exf.mchub.ga/backgrounds/3.png)", "url(https://exf.mchub.ga/backgrounds/4.png)", "url(https://exf.mchub.ga/backgrounds/5.png)", "url(https://exf.mchub.ga/backgrounds/6.png)"];

class MCHubHeader extends HTMLElement {
  connectedCallback() {
    this.innerHTML = '<div class="logo"><img src="https://exf.mchub.ga/logos/logo.png" alt="MC Hub Logo" width="260" height="63"/><br></div><div class="navbar"><div class="dropdown"><button class="dropbtn">Menu</button><div class="dropdown-content"><a href="/">Hub</a><a href="/tips">Tips</a><a href="/facts">Facts</a><a href="/seeds">Seeds</a><a href="/commands">Commands</a><a href="/search"> Search </a></div></div></div><br><br><br>';
  }
}

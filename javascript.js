...
class MCHubHeader extends HTMLElement {
  connectedCallback() {
    ...
    this.insertAdjacentHTML("beforeend", '<div class="message" style="border: 3px solid #FF0000;"><h3> MC Hub is now <b>unmaintained</b>! </h3><p> Content may be outdated or incorrect. </p><p> We are not accepting applications for new maintainers but feel free to create a pull request on <a href="https://github.com/MC-Hub-Official/MC-Hub-Official.github.io">GitHub</a>. </p><p> The domain name will not be renewed; you\'ll be able to access it through <a href="https://MC-Hub-Official.github.io/">https://MC-Hub-Official.github.io/</a>.</p><p> I have lost interest in Minecraft (ninjadev64/ninjagamer64) and the other two maintainers have lost interest in this project. </p><p> We may update the website once in a while but very rarely. The YouTube channel is no longer available. </p></div><br />')
  }
}
